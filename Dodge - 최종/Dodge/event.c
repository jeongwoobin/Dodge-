...
void printGameName() {
	gotoxy(8, 5); printf("■■■      ■■    ■■■      ■■    ■■■"); delay(80);
	gotoxy(8, 6); printf("■    ■  ■    ■  ■    ■  ■        ■"); delay(80);
	gotoxy(8, 7); printf("■    ■  ■    ■  ■    ■  ■  ■■  ■■■"); delay(80);
	gotoxy(8, 8); printf("■    ■  ■    ■  ■    ■  ■    ■  ■"); delay(80);
	gotoxy(8, 9); printf("■■■      ■■    ■■■      ■■    ■■■"); delay(80);
}
...
//SOUND
void playDestroy() {
	sndPlaySoundA("sound\\destroy.wav", SND_ASYNC | SND_NODEFAULT);
}

void playClear() {
	sndPlaySoundA("sound\\clear.wav", SND_ASYNC | SND_NODEFAULT);
}

void playBgm() {
	sndPlaySoundA("sound\\bgm.wav", SND_ASYNC | SND_NODEFAULT | SND_LOOP);
}

void playMain() {
	sndPlaySoundA("sound\\main.wav", SND_ASYNC | SND_NODEFAULT | SND_LOOP);

}

void playEnter() {
	sndPlaySoundA("sound\\enter.wav", SND_ASYNC | SND_NODEFAULT);
}
